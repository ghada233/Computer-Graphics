...
public class MyPanel extends JPanel {
 ...
 public void paint(Graphics g) {
  ...
  g2D.drawOval(200, 100, 20, 70);
  g2D.fillOval(200, 100, 20, 70);
  ...
  g2D.fillOval(200, 100, 20, 70);
   ...
   g2D.setPaint(Color.MAGENTA);
  g2D.drawOval(200, 100, 70, 20);
  g2D.fillOval(200, 100, 70, 20);
  
  
  g2D.setPaint(Color.orange);
  g2D.drawOval(200, 100, 20, 20);
  g2D.fillOval(200, 100, 20, 20);
  
   g2D.setPaint(Color.magenta);
  g2D.setFont(new Font("Ink Free",Font.BOLD,10));
  g2D.drawString("U R A WINNER! :Ghada", 10, 30); 
     /* 
  Graphics2D g2D = (Graphics2D) g;
  //line   
